...
- Any item containing "SHOESTRING" → insert the word "Fries" immediately after "Shoestring" in the name if not already there (e.g. "Ore Ida Shoestring" → "Ore Ida Shoestring Fries") (category: Frozen Foods)
